...
//        void update();
        ...
        void renderSprite(Object type, int x, int y, int8_t xOffset, int8_t yOffset, Direction direction, uint8_t frame, bool showEnemies, bool renderHealth, int healthValue);
