...
const uint8_t MAP_Segment_Type09_00[] = {
  // 0, 1, 2, 3, 4, 5, 6, 7, 8
    ...
    38,38,38,35, 0,23,38,38,38,  // 3
     0, 0, 0, 0, 0,23,38,38,38,  // 4
    38,38,38,37, 0,23,38,38,38,  // 5
...
const uint8_t MAP_Segment_Type09_03[] = {
  // 0, 1, 2, 3, 4, 5, 6, 7, 8
     0, 0, 0,21, 0,34,24,24, 0,  // 0
     0, 0, 0,21, 0, 0, 0, 0,23,  // 1
     0, 0, 0,21, 0, 0, 0, 0,65,  // 2
    ...
    1,Object::Floater,6,2,HEALTH_FLOATER,
...
const uint8_t MAP_Segment_Type09_04[] = {
  // 0, 1, 2, 3, 4, 5, 6, 7, 8
    ...
    21, 0, 0,47,44,24,24,24, 0,  // 2
    35, 0, 0, 0, 0, 0, 0, 0,23,  // 3
     0, 0, 0, 0, 0, 0, 0, 0,23,  // 4
    36, 0, 0, 0, 0, 0, 0, 0,65,  // 5
     0,22,22,22,44,48, 0, 0,23,  // 6
    38,38,38,21, 0, 0, 0, 0,23,  // 7
    38,38,38,21, 0,37,22,22, 0,  // 8
    ...
    1,Object::Floater,4,4,HEALTH_FLOATER,
...
const uint8_t MAP_Segment_Type09_05[] = {
  // 0, 1, 2, 3, 4, 5, 6, 7, 8
    ...
    1,Object::Floater,6,3,HEALTH_FLOATER,
    1,Object::Floater,6,5,HEALTH_FLOATER,
