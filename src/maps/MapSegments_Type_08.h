...
const uint8_t MAP_Segment_Type08_00[] = {
  // 0, 1, 2, 3, 4, 5, 6, 7, 8
    ...
    38,38,38,21, 0,38,38,38,38,  // 6
    38,38,38,12, 0,38,38,38,38,  // 7
    38,38,38,12, 0,38,38,38,38,  // 8
