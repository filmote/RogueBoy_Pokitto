...
const uint8_t MAP_Segment_Type14_00[] = {
  // 0, 1, 2, 3, 4, 5, 6, 7, 8
    ...
    38,38, 0,24,24,24,24,24,24,  // 3
    38,38,21, 0, 0, 0, 0, 0, 0,  // 4
    38,38, 0,22,22,22,22,22,22,  // 5
